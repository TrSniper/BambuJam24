...
//     version 1.11.2
//     from Assets/Scripts/Input/CatInput.inputactions
//
...
public partial class @CatInput: IInputActionCollection2, IDisposable
{
    ...
    ~@CatInput()
    {
        UnityEngine.Debug.Assert(!m_Cat.enabled, "This will cause a leak and performance issues, CatInput.Cat.Disable() has not been called.");
    }
